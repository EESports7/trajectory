...
const std::unordered_set<int> portalIDs = { 101, 99, 11, 10, 200, 201, 202, 203, 1334, 2926, 12, 13, 47, 111, 660, 745, 1331, 1933 };
const std::unordered_set<int> padIDs = { 140, 35, 1332, 67, 3005 };
const std::unordered_set<int> orbIDs = { 141, 36, 1333, 84, 1022, 3004, 1330, 1704, 1751 };
...
const std::unordered_set<int> objectTypes = { 0, 2, 47, 25, 9, 8, 34, 44, 10, 42, 5, 6, 16, 19, 26, 27, 33, 41, 40, 11, 12, 13, 29, 32, 35, 37, 38, 43 };
...
public:
    ...
    static void handlePortal(PlayerObject* player, EffectGameObject* obj);
    static void handlePad(PlayerObject* player, EffectGameObject* obj);
    static void handleOrb(PlayerObject* player, EffectGameObject* obj);
    ...
    std::vector<EffectGameObject*> p1Collided;
    std::vector<EffectGameObject*> p2Collided;

    bool canHitOrb = false;
    bool preHold = false;
