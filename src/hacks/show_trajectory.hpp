...
const std::unordered_set<int> orbIDs = { 141, 36, 1334, 84, 3004 };
...
const std::unordered_set<int> objectTypes = { 0, 2, 47, 25, 9, 8, 34, 44, 10, 42, 5, 6, 16, 19, 26, 27, 33, 41, 40, 11, 12, 13, 29, 35, 37, 38, 43 };
